...
//region
	 ...
	 * 
	 * @return TreeMap<Service, TreeMap<LocalDate, TreeMap<LocalTime, Slot>>>	- a list of all booked slots for all dates under all services
	 */
	public static TreeMap<Service, TreeMap<LocalDate, TreeMap<LocalTime, Slot>>> getSlots() {
		return slots;
	}
	...
	public static ArrayList<Slot> getAvailableSlots(LocalDate date, Service service) {
		...
		if (service != null) {
			...
			for (Service serviceElem : ServiceRepository.getServices()) {
