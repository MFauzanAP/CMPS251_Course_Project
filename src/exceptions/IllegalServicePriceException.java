 ...
 * @since		1.6
 */
public class IllegalServicePriceException extends RuntimeException {
...
//region
	...
	/**
     * Constructs an {@code IllegalServicePriceException} with the specified error message.
     *
     * @param   errorMessage		the error message.
     */
	public IllegalServicePriceException(String errorMessage) {
		super(errorMessage);
	}
